...
function calcTotals(data) {
  ...
  const pastBalanceDue = +(data.pastBalanceDue ?? 0) || 0;
  ...
  const grand = +(sub + cgst + sgst + pastBalanceDue).toFixed(2);
  return { taxable, svc, sub, cgst, sgst, pastBalanceDue, grand, lineItems };
}
